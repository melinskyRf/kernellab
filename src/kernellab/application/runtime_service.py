...
class RuntimeService:
    ...
    def _build_config(self, lab_config: KernellabConfig) -> dict:
        return {
    ...
    def _check_result(self, result, job_id: str, operation: str) -> None:
    ...
    def run_lab(self, lab_config: KernellabConfig, lab_id: str) -> tuple:
        ...
        config = self._build_config(lab_config)
    ...
    def up_lab(self, lab_config: KernellabConfig, lab_id: str) -> tuple:
    ...
    def start_lab(self, lab_config: KernellabConfig, lab_id: str) -> tuple:
    ...
    def destroy_lab(self, lab_config: KernellabConfig, lab_id: str) -> tuple:
        """Destroy a VM."""
    ...
    def status_lab(self, lab_config: KernellabConfig, lab_id: str) -> dict:
